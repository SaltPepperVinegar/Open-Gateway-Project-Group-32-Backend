...
TOKEN_URL = (
    "https://poochie.example.com/auth/realms/operator/protocol/openid-connect/token"
)


NUMBER_VERFICATION_URL = (
    "https://poochie.example.com/camara/number-verification/v1/verify"
)
NUMBER_VERFICATION_SCOPE = "openid number-verification:verify"

REGION_DEVICE_COUNT_URL = (
    "https://poochie.example.com/camara/region-device-count/v2/count"
)
