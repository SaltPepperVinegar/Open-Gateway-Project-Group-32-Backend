...
REGION_DEVICE_COUNT_URL = "https://poochie.example.com/camara/region-device-count/v0/count"
REGION_DEVICE_COUNT_SCOPE = "region-device-count" 



POPULATION_DENSITY_DATA_URL = "https://poochie.example.com/camara/population-density-data/v1/retrieve"
